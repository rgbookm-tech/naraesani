    ...
    activities: [
      {
        ...
        data: {
          image: './public/images/sani_ah.png',
        },
      },
      {
        type: 'stroke-order',
    ...
    activities: [
      {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_ya.png',
        },
      },
      ...
      { type: 'drawing', title: 'ㅑ 따라 쓰기', instruction: '네모 칸에 맞춰 글자를 예쁘게 써보세요.', data: {} },
      {
        ...
        data: {
          pairs: [
            { id: 1, word: '야구', image: './public/images/yagu.png' },
            { id: 2, word: '고양이', image: './public/images/cat.png' },
            { id: 3, word: '야자수', image: './public/images/yajasu.png' },
            { id: 4, word: '야채', image: './public/images/yachae.png' },
          ],
        },
      },
      {
    ...
    activities: [
       {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_eo.png',
        },
      },
    ...
    activities: [
       {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_yeo.png',
        },
      },
    ...
    activities: [
       {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_o.png',
        },
      },
    ...
    activities: [
       {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_yo.png',
        },
      },
    ...
    activities: [
       {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_u.png',
        },
      },
    ...
    activities: [
      {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_yu.png',
        },
      },
/*
      {
    ...
    activities: [
       {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_eu.png',
        },
      },
       {
        type: 'vowel-input',
    ...
    activities: [
       {
        ...
        instruction: '그림을 보고 따라 해보세요!',
        data: {
          image: './public/images/sani_i.png',
        },
      },
